...
!function (e, t) {
    ...
    var L = {
        ...
        }, fitDataFill: k, fitDataTable: k, fitDataStretch: function (e, t) {
    ...
    var P = Object.freeze({
        ...
        }, LayoutModule: S, LocalizeModule: z
    });
    ...
    class F {
        static registry = {
            tables: [], register(e) {
                ...
                } else "undefined" != typeof HTMLElement && e instanceof HTMLElement || e instanceof F ? (s = F.registry.matchElement(e)) && o.push(s) : Array.isArray(e) ? e.forEach((function (e) {
                    o = o.concat(F.registry.lookupTable(e))
                })) : t || console.warn("Table Connection Error - Invalid Selector", e);
                return o
            }, matchElement: e => F.registry.tables.find((function (t) {
    ...
    class H extends F {
        ...
        static _registerModuleExtensions(e) {
            ...
            if (e.moduleExtensions) for (let e in t) {
                let i = t[e];
                if (H.moduleBindings[e]) for (let t in i) H._extendModule(e, t, i[t]); else {
        ...
        _bindModules() {
            ...
            for (var s in this.modules = {}, H.moduleBindings) {
                let o = H.moduleBindings[s], n = new o(this);
    ...
    class O extends H {
        ...
        initializeCoreSystems(e) {
            this.columnManager = new u(this), this.rowManager = new f(this), this.footerManager = new v(this), this.dataLoader = new E(this), this.alertManager = new _(this), this._bindModules(), this.options = this.optionsList.generate(O.defaultOptions, e), this._clearObjectPointers(), this._mapDeprecatedFunctionality(), this.externalEvents = new y(this, this.options, this.options.debugEventsExternal), this.eventBus = new R(this.options.debugEventsInternal), this.interactionMonitor = new w(this), this.dataLoader.initialize(), this.footerManager.initialize()
        }
    ...
    function I(e, t) {
        ...
        })); else if ("object" == typeof e) for (var s in e) i = i.concat(I(e[s], t ? t + "[" + s + "]" : s)); else i.push({
            key: t,
            value: e
        });
        return i
    ...
    function G(e, t) {
        ...
        })); else if ("object" == typeof e) for (var s in e) i = i.concat(G(e[s], t ? t + "[" + s + "]" : s)); else i.push({
            key: t,
            value: e
        });
        return i
    ...
    class ${constructor(e){return this._row=e,new Proxy(this,{get:function(e,t,i){return void 0!==e[t]?e[t]:e._row.table.componentFunctionBinder.handle("row",e._row,t)}
})
}
getData(e)
{
...
class Z extends M {
    ...
    generateRow(e, t) {
        ...
        return this.table.modExists("mutator") && this.table.modules.mutator.disable(), i = new p(s, this, "calc"), this.table.modExists("mutator") && this.table.modules.mutator.enable(), i.getElement().classList.add("tabulator-calcs", "tabulator-calcs-" + e), i.component = !1, i.getComponent = () => (i.component || (i.component = new $(i)), i.component), i.generateCells = () => {
            var t = [];
    ...
    getResults() {
        ...
        })) : e = {top: this.topRow ? this.topRow.getData() : {}, bottom: this.botRow ? this.botRow.getData() : {}}, e
    }
...
var ee = {
    csv: function (e, t = {}, i) {
        ...
        var s = [], o = [], n = {},
            ...
            a = t.rowCalcStyles || {fontStyle: "bold", fontSize: 10, cellPadding: 4, fillColor: 232}, l = t.jsPDF || {},
            h = t.title ? t.title : "";
        ...
        var o = i.sheetName || "Sheet1", n = XLSX.utils.book_new(), r = new t(this),
            a = !("compress" in i) || i.compress, l = i.writeOptions || {bookType: "xlsx", bookSST: !0, compression: a};
        ...
        function h() {
            ...
            })), XLSX.utils.sheet_add_aoa(s, t), s["!ref"] = XLSX.utils.encode_range(o), i.length && (s["!merges"] = i), s
        }
...
class de extends M {
    ...
    rowLookup(e) {
        ...
        })) : (t = de.rowLookups[e] || de.rowLookups.active, i = t.call(this.table)), Object.assign([], i)
    }
                ...
                if (void 0 === e.modules.filter.prevSuccess || e.modules.filter.prevSuccess !== t) {
                    if (e.modules.filter.prevSuccess = t, e.modules.filter.emptyFunc(t)) delete i.headerFilters[s]; else {
                        switch (e.modules.filter.value = t, typeof e.definition.headerFilterFunc) {
                            case"string":
                                ue.filters[e.definition.headerFilterFunc] ? (r = e.definition.headerFilterFunc, o = function (i) {
...
var Ee = {
    csv: function (e) {
        ...
        var i = XLSX.read(e), s = i.Sheets[i.SheetNames[0]];
...
class ye extends M {
    ...
    importFromFile(e, t, i) {
        ...
        if (s) return this.pickFile(t, i).then(this.importData.bind(this, s)).then(this.structureData.bind(this)).then(this.setData.bind(this)).catch((e => (this.dispatch("import-error", e), this.dispatchExternal("importError", e), console.error("Import Error:", e || "Unable to import file"), Promise.reject(e))))
    }
    ...
    pickFile(e, t) {
        return new Promise(((i, s) => {
            ...
            o.type = "file", o.accept = e, o.addEventListener("change", (e => {
                var n = o.files[0], r = new FileReader;
...
class Te extends M {
    ...
    mapBindings(e) {
        for (let t in e) Te.actions[t] ? e[t] && ("object" != typeof e[t] && (e[t] = [e[t]]), e[t].forEach((e => {
...
class _e extends M {
    ...
    initialize() {
        if (this.table.options.persistence) {
            ...
            this.mode = !0 !== t ? t : this.localStorageTest() ? "local" : "cookie", this.table.options.persistenceReaderFunc ? "function" == typeof this.table.options.persistenceReaderFunc ? this.readFunc = this.table.options.persistenceReaderFunc : _e.readers[this.table.options.persistenceReaderFunc] ? this.readFunc = _e.readers[this.table.options.persistenceReaderFunc] : console.warn("Persistence Read Error - invalid reader set", this.table.options.persistenceReaderFunc) : _e.readers[this.mode] ? this.readFunc = _e.readers[this.mode] : console.warn("Persistence Read Error - invalid reader set", this.mode), this.table.options.persistenceWriterFunc ? "function" == typeof this.table.options.persistenceWriterFunc ? this.writeFunc = this.table.options.persistenceWriterFunc : _e.writers[this.table.options.persistenceWriterFunc] ? this.writeFunc = _e.writers[this.table.options.persistenceWriterFunc] : console.warn("Persistence Write Error - invalid reader set", this.table.options.persistenceWriterFunc) : _e.writers[this.mode] ? this.writeFunc = _e.writers[this.mode] : console.warn("Persistence Write Error - invalid writer set", this.mode), this.id = "tabulator-" + (i || this.table.element.getAttribute("id") || ""), this.config = {
...
var We = {
    ...
    }, datetime: Ne, boolean: function (e, t, i, s, o, n, r) {
...
var Ke = Object.freeze({
    ...
    GroupRowsModule: class extends M {
        ...
        rowMoving(e, t, i) {
            if (this.table.options.groupBy) {
                ...
                var s = t instanceof be ? t : t.modules.group, o = e instanceof be ? e : e.modules.group;
    ...
    SelectRangeModule: class extends M {
        ...
        navigate(e, t, i) {
            ...
            if (this.ranges.length > 1 && (this.ranges = this.ranges.filter((e => e === this.activeRange ? (e.setEnd(e.start.row, e.start.col), !0) : (e.destroy(), !1)))), o = this.activeRange, r = (n = t ? o.end : o.start).row, a = n.col, e) switch (i) {
                case"left":
            ...
            return this.rowHeader && 0 === a && (a = 1), s = a !== n.col || r !== n.row, t || o.setStart(r, a), o.setEnd(r, a), t || (this.selecting = "cell"), s ? (l = this.getRowByRangePos(o.end.row), h = this.getColumnByRangePos(o.end.col), "left" !== i && "right" !== i || null !== h.getElement().parentNode ? "up" !== i && "down" !== i || null !== l.getElement().parentNode ? this.autoScroll(o, l.getElement(), h.getElement()) : l.getComponent().scrollTo(void 0, !1) : h.getComponent().scrollTo(void 0, !1), this.layoutElement(), !0) : void 0
        }
        ...
        autoScroll(e, t, i) {
            ...
            void 0 === t && (t = this.getRowByRangePos(e.end.row).getElement()), void 0 === i && (i = this.getColumnByRangePos(e.end.col).getElement()), this.rowHeader && (s = this.rowHeader.getElement()), o = {
                left: i.offsetLeft,
